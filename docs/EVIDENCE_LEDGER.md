...
| 2026-07-20 | **面積量測鏈實拍精度閉環(v2 驗證單,可作送件證據)**:ArUco v2(方形20mm/marker12mm id7)+比例法,實拍 **平均\|誤差\| 1.9%、最大 4.3%** | v2 驗證單(gen_area_validation_v2.py,幾何程式保證、自驗<0.7%)實印實拍 n=15(1.01/3.02/5.02/10.04/16.04 cm² × 斜角 0/30/60°):0°=2.3%、30°=1.4%、60°=2.1%,ArUco 15/15 偵測;斜角至 60° 無系統性劣化(傷口緊鄰貼紙設計奏效) | 舊單 -19% 系統偏差(2026-07-16 列)——確證為舊貼紙問題,量測鏈無罪 | `傷口面積計測標準_Aruco_V2/`(HEIC n=15)、gen_area_validation_v2.py、verify_area_sheet.py |
